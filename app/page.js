...
export default function Page() {
    ...
    const GetUsers = async (e) => {
        const res = await fetch('https://python-flask-practice.vercel.app/usersGet')
    ...
    const PostSubmit = async (e) => {
        e.preventDefault();
        const res = await fetch("https://python-flask-practice.vercel.app/userAdd", {
            method: "POST",
            headers: {
    ...
    const UserDelete = async (id) => {
        const res = await fetch(`https://python-flask-practice.vercel.app/usersDelete/${id}`, {
            method: "DELETE",
          });
         const response = await res.json();
